...
int main(int argc, char *argv[])
{
  ...
  DIMMER LT1((char *)"aut1", (char *)"localhost", 1883, (char *)"LT1", 8*60*60*1000); // Patio
  DIMMER LT2((char *)"aut2", (char *)"localhost", 1883, (char *)"LT2", 8*60*60*1000);  // Salon quincho
  DIMMER LT3((char *)"aut3", (char *)"localhost", 1883, (char *)"LT3", 8*60*60*1000);  // Ingreso quincho
  DIMMER LT4((char *)"aut4", (char *)"localhost", 1883, (char *)"LT4", 1*60*60*1000);  // Baño
  DIMMER LT5((char *)"aut5", (char *)"localhost", 1883, (char *)"LT5", 8*60*60*1000); // Cocina quincho
